        ...
        <div class="card-body p-5">
            <div>
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted small">Daftar untuk memulai</p>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0" placeholder="Nama lengkap" wire:model="name">
                    </div>
                    @error('name')
                ...
                <div class="text-center mt-4">
                    <p class="text-muted mb-0">Sudah memiliki akun? <a href="{{ route('auth.login') }}" class="text-decoration-none fw-semibold">Masuk</a></p>
                </div>
            </div>
        </div>
    </div>
